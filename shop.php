                    ...
                    <div class="right-product-box">
                        <div class="product-item-filter row">
                            <div class="col-12 col-sm-8 text-center text-sm-left">
                               <p><b><h2><center>Showing all results</center></h2></b></p>
                            </div>
                        </div>
										...
										<?php
											...
											{  
												while($row = mysqli_fetch_assoc($result))
												{
													...
													echo "</div>";
													echo '<img src='.$row["item_location"].' class="img-fluid" alt="Image">';
													echo '<div class="mask-icon">';
													echo '<a class="cart" href="addtocart.php">Add to Cart</a>';
													echo "</div>";
													echo "</div>";
													echo '<div class="why-text">';
													echo "<h4>".$row["item_name"]."</h4>";
													echo "<h5>₹".$row["item_price"]."- ".$row["item_weight"]."kg</h5>";
													//$sum+=$row["item_price"];
													echo "</div>";
													echo "</div>";
													echo "</div>";
        ...
        <div class="main-instagram owl-carousel owl-theme">
            <div class="item">
                <div class="ins-inner-box">
                    <img src="images/jaggery_powder.jpg" alt="" />
                    <div class="hov-in">
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="images/jaggery_block.jpg" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="images/chana_besan.jpg" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="images/jowar_atta.jpg" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            ...
            <div class="item">
                <div class="ins-inner-box">
                    <img src="images/groundnut_oil.jpg" alt="" />
                    <div class="hov-in">
                        <a href="#"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
